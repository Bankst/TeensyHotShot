...
TARGET_NAME      := TeensyHotShot
BOARD_ID         := TEENSY31

MCU              := mk20dx256

LIBS_SHARED_BASE := C:\Users\Banks\Documents\Arduino\libraries
LIBS_SHARED      := 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := AceButton ADC SPI TeensyThreads EEPROM LedControl 
...
DEFINES     := -D__MK20DX256__ -DTEENSYDUINO=146 -DARDUINO=10807
